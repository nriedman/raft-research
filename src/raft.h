...
#define HEARTBEAT_INTERVAL_USEC     1000*2  *1000   // 50 ms
#define ELECTION_INTERVAL_MIN_USEC  1000*10 *1000   // 150 ms
#define ELECTION_INTERVAL_MAX_USEC  1000*10 *1000   // 300 ms
